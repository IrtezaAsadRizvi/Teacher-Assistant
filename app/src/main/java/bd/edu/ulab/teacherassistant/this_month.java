...
public class this_month extends AppCompatActivity
    ...
    static StringBuffer time_buffer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this_month = Current.get(java.util.Calendar.MONTH);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.this_month, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.close) {
            Intent i = new Intent(this_month.this,MainActivity.class);
            startActivity(i);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.schedules) {
            ...
            Intent i = new Intent(this_month.this,About.class);
            startActivity(i);
            overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
        } else if (id == R.id.nav_dev) {
            Intent i = new Intent(this_month.this,Developers.class);
            startActivity(i);
            overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
        }
    ...
    public void showAll(){
        ...
        for (int i = 0;i<schedule_num;i++){
            if((Integer.parseInt(months[i])-1) == this_month){
                ...
                //SETTING UP CALENDER
                dateTime.set(java.util.Calendar.DAY_OF_MONTH,Integer.parseInt(day_in_months[i]));
                dateTime.set(java.util.Calendar.MONTH,(Integer.parseInt(months[i])-1));
                dateTime.set(java.util.Calendar.YEAR,Integer.parseInt(years[i]));
                dateTime.set(java.util.Calendar.HOUR_OF_DAY,Integer.parseInt(hours[i]));
                dateTime.set(java.util.Calendar.MINUTE,Integer.parseInt(mins[i]));
